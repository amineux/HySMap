...
The implementation is **inspired by** two public preprints; it is not a dump of the authors’ code and does not claim their experimental tables. Numeric toys (15 vs 5 hops, rates, partition, ΔJ) live in [`docs/examples/`](examples/). Phases 1–6 are in [`docs/phases/`](phases/).
